...
from analyze_centering import analyse_centering
...
auswertungs_verzeichnis = '/pfad/zum/auswertungsverzeichnis'

# Entpacken Sie die Zip-Datei in ein temporäres Verzeichnis
temp_verzeichnis = '/pfad/zum/temporären/verzeichnis'
...
def verarbeite_bild(json_array, bild_pfad):
    ...
    bearbeitetes_array_centering = analyse_centering(json_array, bild_pfad)
    bearbeitetes_array_edge = analyse_edge(json_array, bild_pfad)
    bearbeitetes_array_corner = analyse_corner(json_array, bild_pfad)
            ...
            if datei.endswith('.zip'):
                ...
                for temp_datei in temp_dateien:
                    ...
                    if temp_datei.endswith('.jpg') or temp_datei.endswith('.png'):
                        ...
                        bearbeitetes_array = verarbeite_bild(json_array, temp_pfad)
                ...
                shutil.rmtree(temp_verzeichnis)
